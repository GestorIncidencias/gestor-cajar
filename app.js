...
async function hacerLoginConCodigo() {
  ...
  await conProcesando(boton, 'Entrando…', async () => {
    ...
    if (r.debeCambiarPassword) {
      document.getElementById('textoCambiarPassword').textContent = 'Has entrado con un código de un solo uso. Pon una contraseña nueva para tu usuario antes de continuar.';
      document.getElementById('cancelarCambiarPasswordBtn').classList.add('oculto');
...
function abrirModalCambiarPassword() {
  document.getElementById('textoCambiarPassword').textContent = 'Pon una contraseña nueva para tu usuario.';
  document.getElementById('cancelarCambiarPasswordBtn').classList.remove('oculto');
  document.getElementById('nuevaPasswordPropia').value = '';
  document.getElementById('cambiarPasswordError').textContent = '';
  document.getElementById('modalCambiarPassword').classList.remove('oculto');
}
